  ...
  return (
    <div className="glass-card p-4">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl" style={iconStyles[colorClass]}>{icon}</div>
        <div>
          <p className="text-xl font-semibold text-[var(--slate-800)]">{value}</p>
